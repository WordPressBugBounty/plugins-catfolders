	...
	public static function getTranslation() {
		return array(
			'global' => array(
				...
				'add_your_first_folder'                 => __( 'Add your first folder', 'catfolders' ),
				'create_folders_to_organize_your_files' => __( 'Create folders to organize your files more easily.', 'catfolders' ),
